...
.. autoclass:: AlignmentStructure
   ...
   .. HACK -- the point here is that we don't want this to appear in the output, but the autosummary should still generate the pages.
      .. autosummary::
         ...
         AlignmentStructure.__new__
         AlignmentStructure.__reduce__
         AlignmentStructure.__reduce_ex__
         AlignmentStructure.__sizeof__
         AlignmentStructure.__subclasshook__
         AlignmentStructure._get_aligned_sequence
         AlignmentStructure._tuples_from_cigar
         AlignmentStructure.get_aligned_query_sequence
         AlignmentStructure.get_aligned_target_sequence
