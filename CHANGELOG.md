...
* Replaced `skbio.sequence.IUPACSequence` with `skbio.sequence.GrammaredSequence` and added `skbio.util.classproperty`.
* DNA, RNA, and Protein are no longer inheritable.
