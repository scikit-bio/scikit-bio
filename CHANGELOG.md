...
* Added parallel beta diversity calculation support via `skbio.diversity.block_beta_diversity`. ([#1181](https://github.com/biocore/scikit-bio/issues/1181), [#1352](https://github.com/biocore/scikit-bio/pull/1352)). 
