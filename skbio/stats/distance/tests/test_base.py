...
class DissimilarityMatrixTests(DissimilarityMatrixTestData):
    def setUp(self):
        ...
        self.dm_2x2_asym = DissimilarityMatrix(self.dm_2x2_asym_data, ["a", "b"])
        ...
        self.dm_transposes = [
            self.dm_1x1,
            self.dm_2x2,
            DissimilarityMatrix([[0, -2], [1, 0]], ["a", "b"]),
            self.dm_3x3,
        ]
    ...
    def test_from_iterable_no_key(self):
        ...
        res = DissimilarityMatrix.from_iterable(iterable, lambda a, b: abs(b - a))
        self.assertEqual(res, exp)
    ...
    def test_from_iterable_with_key(self):
        ...
        res = DissimilarityMatrix.from_iterable(
    ...
    def test_from_iterable_with_key_and_keys(self):
        ...
        with self.assertRaises(ValueError):
            DissimilarityMatrix.from_iterable(
    ...
    def test_filter_reorder(self):
        ...
        order = ["c", "a", "b"]
        exp = DissimilarityMatrix([[0, 4.2, 12], [4.2, 0, 0.01], [12, 0.01, 0]], order)
...
class DistanceMatrixTests(DissimilarityMatrixTestData):
    ...
    def test_init_from_condensed_form(self):
        data = [1, 2, 3]
        exp = DistanceMatrix([[0, 1, 2], [1, 0, 3], [2, 3, 0]], ["0", "1", "2"])
    ...
    def test_from_iterable_validate_false(self):
        ...
        exp = DistanceMatrix([[0, 1, 2, 3], [1, 0, 1, 2], [2, 1, 0, 1], [3, 2, 1, 0]])
        res = DistanceMatrix.from_iterable(
