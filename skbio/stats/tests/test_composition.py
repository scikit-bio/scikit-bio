...
class CompositionTests(TestCase):
    ...
    def test_closure(self):
        npt.assert_array_almost_equal(_closure(self.data1),
                                      np.array([[.2, .2, .6],
                                                [.4, .4, .2]]))
        npt.assert_array_almost_equal(_closure(self.data2),
                                      np.array([.2, .2, .6]))
        npt.assert_array_almost_equal(_closure(self.data6),
                                      np.array([[.2, .2, .6],
                                                [.4, .4, .2]]))
    ...
    def test_perturb(self):
        ...
        npt.assert_array_almost_equal(pmat,
                                      np.array([[.2, .2, .6],
                                                [.4, .4, .2]]))
        ...
        npt.assert_array_almost_equal(pmat, np.array([1./6, 2./6, 3./6]))
    ...
    def test_power(self):
        ...
        npt.assert_array_almost_equal(pmat, np.array([.04, .04, .36])/.44)
    ...
    def test_perturb_inv(self):
        ...
        npt.assert_array_almost_equal(pmat, imat)
        pmat = perturb_inv(_closure(self.data1), np.array([1, 1, 1]))
        npt.assert_array_almost_equal(pmat,
                                      np.array([[.2, .2, .6],
                                                [.4, .4, .2]]))
    ...
    def test_multiplicative_replacement(self):
        ...
        npt.assert_array_almost_equal(amat,
        ...
        npt.assert_array_almost_equal(amat, np.array([0.09056604, 0.18113208,
                                                      0.27169811, 0.00377358,
                                                      0.45283019]))
    ...
    def test_clr(self):
        ...
        npt.assert_array_almost_equal(cmat,
