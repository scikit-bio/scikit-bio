 ...
 */
    ...
    if (__pyx_t_14 < 0) {
      ...
      if (unlikely(__pyx_t_14 < 0)) __pyx_t_6 = 0;
    } else if (unlikely(__pyx_t_14 >= __pyx_pybuffernd_permuted.diminfo[0].shape)) __pyx_t_6 = 0;
    if (unlikely(__pyx_t_6 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_6);
      __PYX_ERR(0, 32, __pyx_L1_error)
    }
    __pyx_t_15 = (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int64_t *, __pyx_pybuffernd_permuted.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_permuted.diminfo[0].strides));
    __pyx_t_6 = -1;
    if (__pyx_t_15 < 0) {
