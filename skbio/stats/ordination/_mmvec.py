...
def random_multimodal(
    ...
    Notes
    -----
    This helper is currently kept private because it is specific to MMvec
    tests. In the future, it may be promoted to a public and generalized
    simulation utility if broader use cases emerge.
