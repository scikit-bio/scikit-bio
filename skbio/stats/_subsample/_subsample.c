...
#endif
#include <math.h>
#define __PYX_HAVE__skbio__stats___subsample___subsample
#define __PYX_HAVE_API__skbio__stats___subsample___subsample
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'skbio.stats._subsample._subsample' */
...
#define __Pyx_MODULE_NAME "skbio.stats._subsample._subsample"
int __pyx_module_is_main_skbio__stats___subsample___subsample = 0;

/* Implementation of 'skbio.stats._subsample._subsample' */
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_5skbio_5stats_10_subsample_10_subsample__subsample_without_replacement(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_counts, PyObject *__pyx_v_n, PyObject *__pyx_v_counts_sum); /* proto */
...
static char __pyx_k_Users_caporaso_Dropbox_code_sci[] = "/Users/caporaso/Dropbox/code/scikit-bio/skbio/stats/_subsample/_subsample.pyx";
static char __pyx_k_unknown_dtype_code_in_numpy_pxd[] = "unknown dtype code in numpy.pxd (%d)";
static char __pyx_k_Format_string_allocated_too_shor[] = "Format string allocated too short, see comment in numpy.pxd";
static char __pyx_k_Non_native_byte_order_not_suppor[] = "Non-native byte order not supported";
static char __pyx_k_ndarray_is_not_Fortran_contiguou[] = "ndarray is not Fortran contiguous";
static char __pyx_k_skbio_stats__subsample__subsampl[] = "skbio.stats._subsample._subsample";
...
static PyObject *__pyx_n_s_skbio_stats__subsample__subsampl;
...
/* "skbio/stats/_subsample/_subsample.pyx":17
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_5skbio_5stats_10_subsample_10_subsample_1_subsample_without_replacement(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_5skbio_5stats_10_subsample_10_subsample_1_subsample_without_replacement = {__Pyx_NAMESTR("_subsample_without_replacement"), (PyCFunction)__pyx_pw_5skbio_5stats_10_subsample_10_subsample_1_subsample_without_replacement, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pw_5skbio_5stats_10_subsample_10_subsample_1_subsample_without_replacement(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("skbio.stats._subsample._subsample._subsample_without_replacement", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_5skbio_5stats_10_subsample_10_subsample__subsample_without_replacement(__pyx_self, __pyx_v_counts, __pyx_v_n, __pyx_v_counts_sum);
...
static PyObject *__pyx_pf_5skbio_5stats_10_subsample_10_subsample__subsample_without_replacement(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_counts, PyObject *__pyx_v_n, PyObject *__pyx_v_counts_sum) {
  ...
  /* "skbio/stats/_subsample/_subsample.pyx":24
 ...
 */
  ...
  /* "skbio/stats/_subsample/_subsample.pyx":25
 * 
 *     unpacked = np.empty(counts_sum, dtype=int)
 *     unpacked_idx = 0             # <<<<<<<<<<<<<<
 *     for i in range(counts.shape[0]):
 ...
 */
  ...
  /* "skbio/stats/_subsample/_subsample.pyx":26
 *     unpacked = np.empty(counts_sum, dtype=int)
 *     unpacked_idx = 0
 *     for i in range(counts.shape[0]):             # <<<<<<<<<<<<<<
 *         cnt = counts[i]
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
    ...
    /* "skbio/stats/_subsample/_subsample.pyx":27
 *     unpacked_idx = 0
 *     for i in range(counts.shape[0]):
 *         cnt = counts[i]             # <<<<<<<<<<<<<<
 *         for j in range(cnt):
 ...
 */
    ...
    /* "skbio/stats/_subsample/_subsample.pyx":28
 *     for i in range(counts.shape[0]):
 *         cnt = counts[i]
 *         for j in range(cnt):             # <<<<<<<<<<<<<<
 *             unpacked[unpacked_idx] = i
 ...
 */
    ...
    for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
      ...
      /* "skbio/stats/_subsample/_subsample.pyx":29
 *         cnt = counts[i]
 *         for j in range(cnt):
 *             unpacked[unpacked_idx] = i             # <<<<<<<<<<<<<<
 *             unpacked_idx += 1
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int64_t *, __pyx_pybuffernd_unpacked.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_unpacked.diminfo[0].strides) = __pyx_v_i;
      ...
      /* "skbio/stats/_subsample/_subsample.pyx":30
 *         for j in range(cnt):
 *             unpacked[unpacked_idx] = i
 *             unpacked_idx += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "skbio/stats/_subsample/_subsample.pyx":32
 *             unpacked_idx += 1
 * 
 *     permuted = np.random.permutation(unpacked)[:n]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "skbio/stats/_subsample/_subsample.pyx":34
 *     permuted = np.random.permutation(unpacked)[:n]
 * 
 *     result = np.zeros_like(counts)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "skbio/stats/_subsample/_subsample.pyx":35
 * 
 *     result = np.zeros_like(counts)
 *     for idx in range(permuted.shape[0]):             # <<<<<<<<<<<<<<
 *         result[permuted[idx]] += 1
 ...
 */
  ...
  for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_10; __pyx_t_16+=1) {
    ...
    /* "skbio/stats/_subsample/_subsample.pyx":36
 *     result = np.zeros_like(counts)
 *     for idx in range(permuted.shape[0]):
 *         result[permuted[idx]] += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "skbio/stats/_subsample/_subsample.pyx":38
 *         result[permuted[idx]] += 1
 * 
 *     return result             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_skbio_stats__subsample__subsampl, __pyx_k_skbio_stats__subsample__subsampl, sizeof(__pyx_k_skbio_stats__subsample__subsampl), 0, 0, 1, 1},
 ...
 */
  ...
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(3, 0, 11, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_caporaso_Dropbox_code_sci, __pyx_n_s_subsample_without_replacement, 17, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_skbio__stats___subsample___subsample) {
    if (__Pyx_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "skbio.stats._subsample._subsample")) {
      if (unlikely(PyDict_SetItemString(modules, "skbio.stats._subsample._subsample", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "skbio/stats/_subsample/_subsample.pyx":13
 ...
 *     cdef:
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5skbio_5stats_10_subsample_10_subsample_1_subsample_without_replacement, NULL, __pyx_n_s_skbio_stats__subsample__subsampl); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "skbio/stats/_subsample/_subsample.pyx":1
 * #!/usr/bin/env python             # <<<<<<<<<<<<<<
 * 
 * # ----------------------------------------------------------------------------
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init skbio.stats._subsample._subsample", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init skbio.stats._subsample._subsample");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
