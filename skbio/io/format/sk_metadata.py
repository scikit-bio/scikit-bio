...
def _sk_metadata_read(fh):
    return sk_MetadataReader(fh).read(Metadata)


@sk_metadata.writer(Metadata)
def _sk_metadata_write(obj, fh):
    sk_MetadataWriter(obj).write(fh)


class sk_MetadataReader:
