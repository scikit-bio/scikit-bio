...
class ClustalHelperTests(TestCase):
    def test_label_line_parser(self):
        self.assertEqual(
            _label_line_parser(StringIO("abc\tucag")), ({"abc": ["ucag"]}, ["abc"])
        )
    ...
    def test_check_lengh(self):
        (
            self.assertEqual(
                False,
                _check_length(
                    {"abc": ["adjfkadfjaksdlfadskfda"], "xyz": ["adjfkadfjaksdlfadsk"]},
                    ["abc", "xyz"],
                ),
            ),
        )
        self.assertEqual(
            True,
            _check_length(
                {"abc": ["adjfkadfjaksdlfadskfda"], "xyz": ["adjfkadfjaksdlfadsksdf"]},
                ["abc", "xyz"],
            ),
        )
        self.assertEqual(
            ...
            _check_length(
                {
                    "abc": ["adjfkadfjaksdlfadskfda", "adjfkadfjaksdlfadskfda"],
                    "xyz": ["adjfkadfjaksdlfadsksdf", "adjfkadfjaksdlfadsksdf"],
                },
                ["abc", "xyz"],
            ),
        )
