    ...
    def setUp(self):
        ...
        self.invalid_fps = map(
            ...
            [
                ...
                ("ordination_error2", "Proportion explained header not found", False),
                ...
                ("ordination_error18", "proportion explained.*eigvals: 8 != 9", True),
                ("ordination_error19", "coordinates.*species.*eigvals: 1 != 2", True),
                ...
                (
                    "ordination_error23",
                    "end of file.*Proportion explained section",
                    True,
                ),
