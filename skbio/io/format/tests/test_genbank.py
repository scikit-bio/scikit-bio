...
class GenBankIOTests(TestCase):
    ...
    def setUp(self):
        ...
        self.locus = (
            ...
            (
                ["LOCUS       NP_001832   360 aa      " "linear   PRI   18-DEC-2001"],
                {
                    "division": "PRI",
                    "mol_type": None,
                    "shape": "linear",
        ...
        self.multi = (
            (
                "gsreildfk",
                {
                    ...
                    "SOURCE": {"ORGANISM": "Bacteria", "taxonomy": "Unclassified."},
  ...
  JOURNAL   DNA Res. 6 (5), 283-290 (1999)
   PUBMED   10574454""".split(
    ...
    def test_genbank_to_protein(self):
        ...
        exp = Protein(exp[0], metadata=exp[1], lowercase=True, interval_metadata=exp[2])
        self.assertEqual(exp, obs)
...
class WriterTests(GenBankIOTests):
    def test_serialize_locus(self):
        for serialized, parsed in self.locus:
            self.assertEqual(_serialize_locus("LOCUS", parsed), serialized[0] + "\n")
