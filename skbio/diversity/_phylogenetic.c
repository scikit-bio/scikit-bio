 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_From_Py_intptr_t((__pyx_t_10[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 196, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_Py_intptr_t((__pyx_t_10[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 203, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
