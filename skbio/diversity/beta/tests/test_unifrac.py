...
class UnifracTests(TestCase):
    ...
    def setUp(self):
        self.unweighted_unifrac = unweighted_unifrac
        self.weighted_unifrac = weighted_unifrac
    ...
    def test_invalid_input(self):
        ...
        self.assertRaises(MissingNodeError, self.unweighted_unifrac, u_counts,
                          v_counts, otu_ids, t)
        self.assertRaises(MissingNodeError, self.weighted_unifrac, u_counts,
                          v_counts, otu_ids, t)
