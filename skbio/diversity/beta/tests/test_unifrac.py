...
class UnifracTests(TestCase):
    ...
    def test_invalid_input(self):
        ...
        self.assertRaises(
            DuplicateNodeError, unweighted_unifrac, u_counts, v_counts, otu_ids, t
        )
        self.assertRaises(
            DuplicateNodeError, weighted_unifrac, u_counts, v_counts, otu_ids, t
        )
        ...
        self.assertRaises(ValueError, weighted_unifrac, u_counts, v_counts, otu_ids, t)
        ...
        self.assertRaises(
            MissingNodeError, unweighted_unifrac, u_counts, v_counts, otu_ids, t
        )
        self.assertRaises(
    ...
    def test_weighted_unifrac_branch_correction(self):
        ...
        v_sum = 3
        exp = np.array([2.0, 5.0 * (.5 + (2.0 / 3.0)), 10.0 * (1.0 / 3.0), 0.0]).sum()
