...
class NucelotideSequenceTests(TestCase):
    ...
    def test_nondegenerates_gap_mixed_case(self):
        ...
        # self.empty = NucleotideSequence('')
        # self.b1 = NucleotideSequence('GAT TACA')
        # self.b2 = NucleotideSequence(
        #     'ACC GGU ACC', id="test-seq-2",
        #     description="A test sequence")
    ...
    def test_translate(self):
        ...
        # start_position = 1
        exp_b1 = ProteinSequence('IT')
        exp_b2 = ProteinSequence('PV')
        self.assertEqual(self.empty.translate(start_position=1), exp_empty)
        self.assertEqual(self.b1.translate(start_position=1), exp_b1)
        self.assertEqual(self.b2.translate(start_position=1), exp_b2)
        # start_position = 2
        exp_b1 = ProteinSequence('L')
        exp_b2 = ProteinSequence('RY')
        self.assertEqual(self.empty.translate(start_position=2), exp_empty)
        self.assertEqual(self.b1.translate(start_position=2), exp_b1)
        self.assertEqual(self.b2.translate(start_position=2), exp_b2)
        # start_position = 3
        exp_b1 = ProteinSequence('Y')
        exp_b2 = ProteinSequence('GT')
        self.assertEqual(self.empty.translate(start_position=3), exp_empty)
        self.assertEqual(self.b1.translate(start_position=3), exp_b1)
        self.assertEqual(self.b2.translate(start_position=3), exp_b2)
        # start_position = 4
        exp_b1 = ProteinSequence('T')
        exp_b2 = ProteinSequence('V')
        self.assertEqual(self.empty.translate(start_position=4), exp_empty)
        self.assertEqual(self.b1.translate(start_position=4), exp_b1)
        self.assertEqual(self.b2.translate(start_position=4), exp_b2)
        # start_position = 5
        exp_b1 = ProteinSequence('')
        exp_b2 = ProteinSequence('Y')
        self.assertEqual(self.empty.translate(start_position=5), exp_empty)
        self.assertEqual(self.b1.translate(start_position=5), exp_b1)
        self.assertEqual(self.b2.translate(start_position=5), exp_b2)
        # start_position = 400
        exp_b1 = ProteinSequence('')
        exp_b2 = ProteinSequence('')
        self.assertEqual(self.empty.translate(start_position=400), exp_empty)
        self.assertEqual(self.b1.translate(start_position=400), exp_b1)
        self.assertEqual(self.b2.translate(start_position=400), exp_b2)

    def test_translate_bad_start_position(self):
        self.assertRaises(IndexError, self.empty.translate, start_position=-42)
