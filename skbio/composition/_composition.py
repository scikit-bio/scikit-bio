...
def closure(mat):
    ...
    --------
    >>> import numpy as np
    >>> from skbio.composition import closure
...
def multi_replace(mat, delta=None):
    ...
    --------
    >>> import numpy as np
    >>> from skbio.composition import multi_replace
...
def perturb(x, y):
    ...
    --------
    >>> import numpy as np
    >>> from skbio.composition import perturb
...
def perturb_inv(x, y):
    ...
    --------
    >>> import numpy as np
    >>> from skbio.composition import perturb_inv
    >>> x = np.array([.1, .3, .4, .2])
...
def power(x, a):
    ...
    --------
    >>> import numpy as np
    >>> from skbio.composition import power
    >>> x = np.array([.1, .3, .4, .2])
    >>> power(x, .1)
...
def inner(x, y):
    ...
    --------
    >>> import numpy as np
    >>> from skbio.composition import inner
    >>> x = np.array([.1, .3, .4, .2])
    >>> y = np.array([.2, .4, .2, .2])
...
def clr(mat):
    ...
    --------
    >>> import numpy as np
    >>> from skbio.composition import clr
    >>> x = np.array([.1, .3, .4, .2])
    >>> clr(x)
...
def clr_inv(mat):
    ...
    --------
    >>> import numpy as np
    >>> from skbio.composition import clr_inv
    >>> x = np.array([.1, .3, .4, .2])
    >>> clr_inv(x)
...
def ilr(mat, basis=None, check=True):
    ...
    --------
    >>> import numpy as np
    >>> from skbio.composition import ilr
    >>> x = np.array([.1, .3, .4, .2])
    >>> ilr(x)
...
def alr(mat, denominator_idx=0):
    ...
    --------
    >>> import numpy as np
    >>> from skbio.composition import alr
    >>> x = np.array([.1, .3, .4, .2])
    >>> alr(x)
...
def alr_inv(mat, denominator_idx=0):
    ...
    --------
    >>> import numpy as np
    >>> from skbio.composition import alr, alr_inv
    >>> x = np.array([.1, .3, .4, .2])
    >>> alr_inv(alr(x))
...
def vlr(x, y, ddof=1, robust=False):
    ...
    --------
    >>> import numpy as np
    >>> from skbio.composition import vlr
    >>> x = np.exp([1, 2, 3])
    >>> y = np.exp([2, 3, 4])
    >>> vlr(x, y)  # no zeros
    0.0
...
def pairwise_vlr(mat, ids=None, ddof=1, robust=False, validate=True):
    ...
    --------
    >>> import numpy as np
    >>> from skbio.composition import pairwise_vlr
...
def ancom(
    ...
    Examples
    --------
    >>> from skbio.composition import ancom
    >>> import pandas as pd
...
def dirmult_ttest(
    ...
    *p*-values will not be reliable. However, the bias is the same across each
    ...
    --------
    >>> import pandas as pd
    >>> from skbio.composition import dirmult_ttest
