...
class TreeNode(SkbioObject):
    ...
    @classonlymethod
    def from_linkage_matrix(cls, linkage_matrix: NDArray, id_list: list) -> TreeNode:
        ...
        # TODO: Why array instead of list here?
        node_lookup: NDArray[TreeNode] = np.empty(lookup_len, dtype=cls)
