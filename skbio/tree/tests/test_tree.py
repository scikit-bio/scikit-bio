...
class TreeTests(TestCase):
    ...
    def test_index_tree(self):
        ...
        nptest.assert_equal(child_1, np.array([[2, 0, 1], [6, 2, 3], [7, 4, 5],
                                               [8, 6, 7]]))
        ...
        nptest.assert_equal(child_2, np.array([[4, 0, 1], [5, 2, 3],
                                               [8, 4, 5], [9, 6, 7],
                                               [10, 8, 9]]))
        ...
        nptest.assert_equal(child_3, np.array([[4, 0, 2], [5, 3, 3], [8, 4, 5],
                                               [9, 6, 7], [10, 8, 9]]))
    ...
    def test_to_array(self):
        ...
        nptest.assert_equal(child_index, arrayed['child_index'])
