...
class TreeTests(TestCase):
    ...
    def test_observed_node_counts(self):
        ...
        self.assertEqual(self.simple_t.observed_node_counts(otu_counts), expected)
        # error on zero count(s)
        otu_counts = {"a": 0}
        self.assertRaises(ValueError, self.simple_t.observed_node_counts, otu_counts)
        ...
        otu_counts = {}
        expected = defaultdict(int)
        self.assertEqual(self.complex_tree.observed_node_counts(otu_counts), expected)
