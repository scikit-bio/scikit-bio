...
class NjTests(TestCase):
    def setUp(self):
        ...
        self.expected1_TreeNode = TreeNode.read(io.StringIO(self.expected1_str))
        ...
        self.expected2_TreeNode = TreeNode.read(io.StringIO(self.expected2_str))
        ...
        self.expected3_TreeNode = TreeNode.read(io.StringIO(self.expected3_str))
    ...
    def test_nj_dm1(self):
        self.assertEqual(nj(self.dm1, result_constructor=str), self.expected1_str)
    ...
    def test_compute_collapsed_dm(self):
        expected_data = [[0, 7, 7, 6], [7, 0, 8, 7], [7, 8, 0, 3], [6, 7, 3, 0]]
