...
class WorkflowTests(TestCase):
    def setUp(self):
        ...
        self.obj_noshort = MockWorkflow(
            [None, None], short_circuit=False, options=opts, stats=defaultdict(int)
        )
...
class RequiresTests(TestCase):
    ...
    def test_methodb2_accept(self):
        ...
        # can execute
        obj = MockWorkflow([None, None], options={"foo": 1}, stats=defaultdict(int))
        obj.initialize_state("test")
        obj.methodB2()
    ...
    def test_methodb2_ignore(self):
        ...
        # we do not execute
        obj = MockWorkflow([None, None], options={"foo": "bar"}, stats=defaultdict(int))
        obj.methodB2()
