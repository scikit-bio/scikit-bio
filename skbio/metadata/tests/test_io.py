...
class TestLoadErrors(unittest.TestCase):
    def test_path_does_not_exist(self):
        with self.assertRaisesRegex(
            ...
            SampleMetadata.load("/qiime2/unit/tests/hopefully/this/path/does/not/exist")
    ...
    def test_column_types_unrecognized_column_type(self):
        ...
        with self.assertRaisesRegex(
            ...
            SampleMetadata.load(
                fp, column_types={"col1": "numeric", "col2": "CATEGORICAL"}
            )
    ...
    def test_unknown_missing_scheme(self):
        ...
        with self.assertRaisesRegex(MetadataFileError, "col1.*BAD:SCHEME.*#sk:missing"):
            SampleMetadata.load(fp)
