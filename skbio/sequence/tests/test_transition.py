...
class TestJC69(TestCase):
    def test_instance(self):
        obs = jc69(0).data
        exp = np.identity(4, dtype=np.float32)
        ...
        exp = np.array(
            [[0.63506, 0.12165, 0.12165, 0.12165],
             ...
             [0.12165, 0.12165, 0.12165, 0.63506]], dtype=np.float32)
        npt.assert_array_equal(obs, exp)
        ...
        exp = np.array(
            [[0.44770, 0.18410, 0.18410, 0.18410],
             ...
             [0.18410, 0.18410, 0.18410, 0.44770]], dtype=np.float32)
        npt.assert_array_equal(obs, exp)

        obs = jc69(10).data.round(5)
        exp = np.full((4, 4), 0.25, dtype=np.float32)
        npt.assert_array_equal(obs, exp)
    ...
    def test_instance(self):
        ...
        exp = np.array(
            [[0.68162, 0.12165, 0.07509, 0.12165],
             ...
             [0.12165, 0.07509, 0.12165, 0.68162]], dtype=np.float32)
        npt.assert_array_equal(obs, exp)
        ...
        exp = np.array(
            [[0.49984, 0.18410, 0.13196, 0.18410],
             ...
             [0.18410, 0.13196, 0.18410, 0.49984]], dtype=np.float32)
        npt.assert_array_equal(obs, exp)
        ...
        exp = np.array(
            [[0.25002, 0.25000, 0.24998, 0.25000],
             ...
             [0.25000, 0.24998, 0.25000, 0.25002]], dtype=np.float32)
        npt.assert_array_equal(obs, exp)
    ...
    def test_instance(self):
        ...
        exp = np.array(
            [[0.44644, 0.11071, 0.16607, 0.27678],
             ...
             [0.0    , 0.11071, 0.16607, 0.72322]], dtype=np.float32)
        npt.assert_array_equal(obs, exp)
        ...
        exp = np.array(
            [[0.19931, 0.16014, 0.24021, 0.40035],
             ...
             [0.0    , 0.16014, 0.24021, 0.59965]], dtype=np.float32)
        npt.assert_array_equal(obs, exp)
        ...
        exp = np.array(
            [[0.00031, 0.19994, 0.29991, 0.49984],
             ...
             [0.0    , 0.19994, 0.29991, 0.50016]], dtype=np.float32)
        npt.assert_array_equal(obs, exp)
        ...
        exp = np.array(
            [[0.12451, 0.35019, 0.0    , 0.52529],
             ...
             [0.0    , 0.35019, 0.0    , 0.64981]], dtype=np.float32)
        npt.assert_array_equal(obs, exp)
        ...
        exp = np.array(
            [[0.0, 0.2, 0.3, 0.5],
             [0.0, 0.2, 0.3, 0.5],
             [0.0, 0.2, 0.3, 0.5],
             [0.0, 0.2, 0.3, 0.5]], dtype=np.float32)
        npt.assert_array_equal(obs, exp)
    ...
    def test_instance(self):
        ...
        exp = np.array(
            [[0.54616, 0.11071, 0.06635, 0.27678],
             ...
             [0.0    , 0.11071, 0.61251, 0.27678],
             [0.0    , 0.08222, 0.16607, 0.75171]], dtype=np.float32)
        npt.assert_array_equal(obs, exp)
        ...
        exp = np.array(
            [[0.60012, 0.21248, 0.13428, 0.05312],
             ...
             [0.05312, 0.13428, 0.21248, 0.60012]], dtype=np.float32)
        npt.assert_array_equal(obs, exp)
        ...
        npt.assert_allclose(
            ...
            f81(0.5, freqs=(0.0, 0.2, 0.3, 0.5)).data, rtol=1e-5,
        )
        npt.assert_allclose(
            hky85(0.5, kappa=0.5, freqs=(0.25, 0.25, 0.25, 0.25)).data,
            k2p(0.5, kappa=0.5).data, rtol=1e-5,
        )
        npt.assert_allclose(
            hky85(0.5, kappa=1, freqs=(0.25, 0.25, 0.25, 0.25)).data,
            jc69(0.5).data, rtol=1e-5,
        )
        ...
        exp = np.array(
            [[0.29829, 0.16014, 0.14122, 0.40035],
             ...
             [0.0    , 0.16014, 0.43952, 0.40035],
             [0.0    , 0.13186, 0.24021, 0.62794]], dtype=np.float32)
        npt.assert_array_equal(obs, exp)
    ...
    def test_instance(self):
        ...
        exp = np.array(
            [[0.56864, 0.11071, 0.04387, 0.27678],
             ...
             [0.0    , 0.11071, 0.61251, 0.27678],
             [0.0    , 0.08839, 0.16607, 0.74554]], dtype=np.float32)
        npt.assert_array_equal(obs, exp)
        ...
        exp = np.array(
            [[0.52458, 0.11071, 0.08793, 0.27678],
             ...
             [0.0    , 0.11071, 0.61251, 0.27678],
             [0.0    , 0.07580, 0.16607, 0.75813]], dtype=np.float32)
        npt.assert_array_equal(obs, exp)
        ...
        exp = np.array(
            [[0.61762, 0.21248, 0.11678, 0.05312],
             ...
             [0.05312, 0.15112, 0.21248, 0.58328]], dtype=np.float32)
        npt.assert_array_equal(obs, exp)
        ...
        npt.assert_allclose(
            ...
            hky85(0.5, kappa=0.5, freqs=(0.0, 0.2, 0.3, 0.5)).data, rtol=1e-5,
        )
        npt.assert_allclose(
        ...
        exp = np.array(
            [[0.32335, 0.16014, 0.11617, 0.40035],
             ...
             [0.0    , 0.16014, 0.43952, 0.40035],
             [0.0    , 0.13846, 0.24021, 0.62133]], dtype=np.float32)
        npt.assert_array_equal(obs, exp)
